...
export default function FinalScreen({ onReplay }) {
  ...
  const proposalMessage = `Dear Aradhya,
...
You are not just my girlfriend, you're the most special part of my life.  
          ...
          {!cardOpen ? (
            ...
            >
              ...
              <h1 className="text-3xl md:text-4xl text-pink-200 mb-8 leading-tight font-semibold">
                This is just for <span className="text-pink-400 font-bold">you, Aradhya...</span>
              </h1>
      ...
      {showOverlay && (
        ...
        >
          ...
          >
            ...
            >
              <p className="text-pink-400/70 text-sm mb-2">
                Replaying in {countdown} seconds...
              </p>
              <motion.button
                onClick={() => window.location.reload()}
                className="text-pink-300 hover:text-pink-200 text-sm underline underline-offset-4"
